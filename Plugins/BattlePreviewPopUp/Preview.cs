...
namespace Grabacr07.KanColleViewer.Plugins
{
	...
	{
		private readonly BattlePreviewsPopUpViewModel battlePreviewsPopUpViewModel = new BattlePreviewsPopUpViewModel();
		...
		{
			return new BattlePreviewsPopUp { DataContext = this.battlePreviewsPopUpViewModel };
		}
	}
}
