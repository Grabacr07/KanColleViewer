...
namespace Grabacr07.KanColleViewer.ViewModels.Contents
{
	public class AdmiralViewModel : ViewModel
	{
		...
		public AdmiralViewModel()
		{
			...
			servers.Add("125.6.184.15", "(구) 구레 진수부");
			servers.Add("203.104.209.71", "요코스카 진수부");
			servers.Add("203.104.209.87", "구레 진수부");
			servers.Add("125.6.184.16", "사세보 진수부");
			servers.Add("125.6.187.205", "마이즈루 진수부");
			servers.Add("125.6.187.229", "오오미나토 경비부");
			servers.Add("125.6.187.253", "트럭 정박지");
			servers.Add("125.6.188.25", "링가 정박지");
			servers.Add("203.104.248.135", "라바울 기지");
			servers.Add("125.6.189.7", "쇼트랜드 정박지");
			servers.Add("125.6.189.39", "부인 기지");
			servers.Add("125.6.189.71", "타위타위 정박지");
			servers.Add("125.6.189.103", "팔라우 정박지");
			servers.Add("125.6.189.135", "브루나이 정박지");
			servers.Add("125.6.189.167", "카사트카만(히토캇푸만) 정박지");
			servers.Add("125.6.189.215", "파라무쉬르 정박지");
			servers.Add("125.6.189.247", "스쿠모만 정박지");
			servers.Add("203.104.209.23", "가노야 기지");
			servers.Add("203.104.209.39", "이와가와 기지");
