...
namespace Grabacr07.KanColleViewer.Views.Behaviors
{
	...
	/// </summary>
	internal class ScreenshotAction : InteractionMessageAction<KanColleHost>
	{
		protected override void InvokeAction(InteractionMessage message)
		{
			...
			try
			{
				...
				const string notFoundMessage = "艦これフレームが見つかりません。";
				if (AssociatedObject.InnermostFrameID < 0)
				{
