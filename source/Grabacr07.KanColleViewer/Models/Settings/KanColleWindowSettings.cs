...
namespace Grabacr07.KanColleViewer.Models.Settings
{
	public class KanColleWindowSettings : WindowSettings
	{
		...
		/// <summary>
		/// メイン ウィンドウの情報表示部分が分割されているかどうかを示す設定値を取得します。
		/// </summary>
		public SerializableProperty<bool> IsDivide => this.Cache(key => new SerializableProperty<bool>(key, Providers.Local, false));
