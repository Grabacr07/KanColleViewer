	...
	internal class B42 : ITracker
	{
		...
		public void RegisterEvent(TrackManager manager)
		{
			manager.BattleResultEvent += (sender, args) =>
			{
				...
				if (fleet?.Ships.Length != 4) return;
		...
		{
			return count >= max_count ? "완료" : "아카츠키,히비키,이카즈치,이나즈마 만으로 편성하여 1-5 보스전 C패배 이상 " + count.ToString() + " / " + max_count.ToString();
		}
